...
\section{Basics}
\label{sec:orgb0956d2}
\subsection{Modern Libraries}
\label{sec:orge251199}
\subsubsection{Libraries}
\label{sec:orgdc4b146}
\begin{enumerate}
\item Async
\label{sec:orga6be53a}
...
\label{sec:org2f0c820}
\subsubsection{Default Directory}
\label{sec:org6b1d7e5}
...
\label{sec:org8c53121}
\subsubsection{Settings}
\label{sec:org6f9234e}
...
\label{sec:org5ee82c7}
\section{Package Management}
\label{sec:orgb830137}
\subsection{Package Management}
\label{sec:org6791211}
\subsubsection{Disable \texttt{package.el}}
\label{sec:org90c6d75}
...
\label{sec:org8c708f1}
\section{Customization}
\label{sec:org552e31f}
\subsection{Customization Group}
\label{sec:org7a6f182}
\subsubsection{THE group}
\label{sec:org5ec7f9e}
...
\label{sec:org5756d32}
\subsection{OS Integration}
\label{sec:orgb788ad0}
\subsubsection{OS-specific Customization}
\label{sec:orgef0440a}
\begin{enumerate}
\item OS detection
\label{sec:orgb53bb47}
...
\label{sec:orgbe27129}
\begin{enumerate}
\item Path Fixes
\label{sec:org888512f}
...
\label{sec:org536d935}
\begin{enumerate}
\item macOS integration
\label{sec:org09092da}
...
\label{sec:org933611d}
\begin{verbatim}
(use-package ssh-config-mode)
\end{verbatim}

\subsubsection{YAML}
\label{sec:org3b11638}
...
\end{verbatim}
\subsection{Emacs}
\label{sec:org1231115}
\subsubsection{emacs.d Organization}
\label{sec:orgf05b6ac}
\begin{enumerate}
\item \texttt{no-littering}
\label{sec:orgd825fd0}
...
\label{sec:org253f19e}
\subsection{Better Help}
\label{sec:org9888f65}
\subsubsection{Helpful}
\label{sec:orgb589f14}
...
\end{verbatim}
\subsection{ElDoc}
\label{sec:org12551fe}
\subsubsection{Settings}
\label{sec:org427b55b}
...
\end{verbatim}
\section{Keybindings}
\label{sec:org9834f60}
\subsection{Binding Keys}
\label{sec:org471cdc7}

\subsubsection{Custom Prefix}
\label{sec:orgc6ea925}
...
\label{sec:org593d798}
\begin{verbatim}
(use-package hydra
  :demand t)
\end{verbatim}
\section{UI}
\label{sec:orgabb66eb}
\subsection{Appearance}
\label{sec:org1fad2da}
\subsubsection{Basic Setup}
\label{sec:org4e7f887}
...
\end{verbatim}
\subsection{Theme}
\label{sec:org21dec7c}
\subsubsection{Utilities}
\label{sec:org93b597d}
...
\label{sec:org6ecb085}
\subsubsection{Diminish}
\label{sec:org71949fa}
...
\end{enumerate}
\subsection{Emojis!}
\label{sec:org81f8efe}
\subsubsection{\texttt{emojify}}
\label{sec:org2200f71}
...
\end{verbatim}
\section{Navigation}
\label{sec:org34fdf71}
\subsection{Completion}
\label{sec:orgfdee2e5}
\subsubsection{Packages}
\label{sec:org1fd38e8}
\begin{enumerate}
\item Smex - Frecency for command history
\label{sec:orgb61d58f}
...
\begin{enumerate}
\item Setup
\label{sec:orge5d8a5d}
\begin{enumerate}
\item Lazy Loading
\label{sec:orgab4b7a2}
...
\begin{enumerate}
\item Setup
\label{sec:org09d40d0}
\begin{enumerate}
\item Bindings
\label{sec:org67d1301}
...
\label{sec:org13ca679}
\subsubsection{Dotfile shortcuts}
\label{sec:org07fda8d}
\begin{enumerate}
\item Prefix key
\label{sec:orgd15c444}
...
\label{sec:org7360aee}
\begin{enumerate}
\item Symlinks
\label{sec:orgdba4b60}
...
\label{sec:orgc351d48}
\begin{enumerate}
\item Projectile
\label{sec:org385dfa0}
...
\begin{enumerate}
\item Setup
\label{sec:org8086aec}
\begin{enumerate}
\item Enable projectile globally
\label{sec:org030422d}
...
\end{enumerate}
\subsection{Search}
\label{sec:orgc1bba8d}
\subsubsection{Regular Expressions}
\label{sec:orgec8dedd}
\begin{enumerate}
\item Rx
\label{sec:orgcbcdf26}
...
\begin{enumerate}
\item Setup
\label{sec:orgb9f82fd}
\begin{enumerate}
\item Version Hack
\label{sec:org926d74d}
...
\item Settings
\label{sec:orga09cbb6}
\begin{verbatim}
(setq org-agenda-files '("~/org"))
\end{verbatim}
\end{enumerate}
\item \texttt{use-package} declaration
\label{sec:org085098d}
\begin{verbatim}
...
\label{sec:orgbf12ef4}
\subsubsection{Flyspell}
\label{sec:org692be7b}
...
\label{sec:org01bd517}
\subsubsection{Formatting Options}
\label{sec:org12fa5b1}
\begin{enumerate}
\item Formatting
\label{sec:orgdbc2ee7}
\begin{enumerate}
\item Sanity
\label{sec:orgf54357b}
...
\end{enumerate}
\section{Reading}
\label{sec:orgf3a5059}
\subsection{PDF Functionality}
\label{sec:orgcd7a0d1}
\subsubsection{\texttt{pdf-tools}}
\label{sec:org29a97a3}
...
\label{sec:orga03c37e}
\subsection{Git integration}
\label{sec:orgf88fd76}
\subsubsection{Direct Interaction}
\label{sec:orgc6dcee4}
...
\label{sec:org1548ddc}
\subsection{Syntax Checking}
\label{sec:orgbf8ec73}
\subsubsection{Flycheck}
\label{sec:org21d897f}
...
\begin{enumerate}
\item Settings
\label{sec:orgc655882}
\begin{enumerate}
\item Enable Flycheck Globally
\label{sec:org920af4f}
...
\label{sec:orgfb7df50}
\subsubsection{Company Settings}
\label{sec:org3e1c175}
\begin{itemize}
...
\end{verbatim}
\section{Languages}
\label{sec:org65634d6}
\subsection{Common Lisp}
\label{sec:orgeccd49f}
\subsubsection{Aggressive Indent}
\label{sec:orgb7fa668}
Enable aggressive indentation in all Lisp modes.
\begin{verbatim}
(add-hook 'lisp-mode-hook #'aggressive-indent-mode)
\end{verbatim}
\subsection{Emacs Lisp}
\label{sec:orgad625ed}
\subsubsection{Hooks}
\label{sec:org60f949e}
...
\subsubsection{Fixes}
\label{sec:org8ac30a1}
\begin{enumerate}
\item Advised Function Noise
\label{sec:org1a5287f}
...
\end{verbatim}
\section{Etc.}
\label{sec:orgcd7663b}
\subsection{Miscellaneous Utilities}
\label{sec:orga877d8d}
\subsubsection{Eventually-obsolete Functions}
\label{sec:org1f9d440}
