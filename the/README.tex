...
\section{Basics}
\label{sec:orgc2b4130}
\subsection{Modern Libraries}
\label{sec:orgb9cf37e}
\subsubsection{Libraries}
\label{sec:orgf66cd0d}
\begin{enumerate}
\item Async
\label{sec:org4174677}
...
\label{sec:org6f0a2e3}
\subsubsection{Default Directory}
\label{sec:org472f836}
...
\label{sec:orgd7ed217}
\subsubsection{Settings}
\label{sec:org4ffadf9}
...
\label{sec:orga67db88}
\section{Package Management}
\label{sec:org8186679}
\subsection{Package Management}
\label{sec:orgef0d5ad}
\subsubsection{Disable \texttt{package.el}}
\label{sec:orgde236cc}
...
\label{sec:org7221a5b}
\subsubsection{El-Patch}
\label{sec:orgc11244b}
...
\label{sec:orga7e19ec}
\subsection{Customization Group}
\label{sec:orgf2c9d06}
\subsubsection{THE group}
\label{sec:orga5f234c}
...
\label{sec:orgf59564f}
\subsection{OS Integration}
\label{sec:org1df5567}
\subsubsection{OS-specific Customization}
\label{sec:org671cee8}
\begin{enumerate}
\item OS detection
\label{sec:org4ca386c}
...
\label{sec:org03cb21f}
\begin{enumerate}
\item Path Fixes
\label{sec:org784285d}
...
\label{sec:orgc6e417a}
\begin{enumerate}
\item macOS integration
\label{sec:org60d71b9}
...
\label{sec:org75c5f0a}
\begin{minted}[]{common-lisp}
(use-package ssh-config-mode)
\end{minted}

\subsubsection{YAML}
\label{sec:org76ba9bc}
...
\end{minted}
\subsection{Emacs}
\label{sec:orge91b603}
\subsubsection{emacs.d Organization}
\label{sec:orgaa49142}
\begin{enumerate}
\item \texttt{no-littering}
\label{sec:org3a491db}
...
\label{sec:orge66d40c}
\subsection{Better Help}
\label{sec:orga227cc4}
\subsubsection{Helpful}
\label{sec:org831c4d2}
...
\end{minted}
\subsection{ElDoc}
\label{sec:orgac6967d}
\subsubsection{Settings}
\label{sec:org2be3e45}
...
\end{minted}
\section{Keybindings}
\label{sec:org81dbf18}
\subsection{Binding Keys}
\label{sec:org5807b54}
\subsubsection{Custom Prefix}
\label{sec:org792d506}
...
\end{minted}
\section{Navigation}
\label{sec:orgaa7a370}
\subsection{Completion}
\label{sec:orgc3547ce}
\subsubsection{Packages}
\label{sec:org47b8857}
\begin{enumerate}
\item Smex - Frecency for command history
\label{sec:orge70f2ea}
...
\begin{enumerate}
\item Setup
\label{sec:orgda2982e}
\begin{enumerate}
\item Lazy Loading
\label{sec:orgc7e5146}
...
\begin{enumerate}
\item Setup
\label{sec:orgd725ab3}
\begin{enumerate}
\item Bindings
\label{sec:org10a8fe4}
...
\label{sec:org548e44a}
\subsubsection{Dotfile shortcuts}
\label{sec:org3cdd60a}
\begin{enumerate}
\item Prefix key
\label{sec:org99bedde}
...
\label{sec:org39d8cc5}
\begin{enumerate}
\item Symlinks
\label{sec:org2d78bf8}
...
\label{sec:orgb820385}
\begin{enumerate}
\item Projectile
\label{sec:orgf7b2948}
...
\begin{enumerate}
\item Setup
\label{sec:orgd81c0d5}
\begin{enumerate}
\item Enable projectile globally
\label{sec:orgf1eceb7}
...
\label{sec:org07b592e}
\subsubsection{Mark Ring Navigation}
\label{sec:org61de8a4}
\begin{minted}[]{common-lisp}
...
\label{sec:org37cd2ea}
\begin{minted}[]{common-lisp}
(use-package expand-region
  :demand t)
\end{minted}
\subsubsection{Vimish Fold}
\label{sec:orge335640}
\begin{minted}[]{common-lisp}
...
\end{minted}
\subsection{Search}
\label{sec:org957f94a}
\subsubsection{Regular Expressions}
\label{sec:orgee44df3}
\begin{enumerate}
\item Rx
\label{sec:org55ad63b}
...
\begin{enumerate}
\item Setup
\label{sec:orgc4b040b}
\begin{enumerate}
\item Version Hack
\label{sec:org9862966}
...
\label{sec:org4fd04b5}
\subsubsection{AUCTeX}
\label{sec:orgd36e4f5}
\begin{minted}[]{common-lisp}
(use-package tex
  :demand t
  :straight auctex
...
\label{sec:org2871332}
\subsubsection{Formatting Options}
\label{sec:org6cc7e67}
\begin{enumerate}
\item Formatting
\label{sec:org47e451d}
\begin{enumerate}
\item Sanity
\label{sec:orga042327}
...
\end{enumerate}
\section{Reading}
\label{sec:org2a4b1c6}
\subsection{PDF Functionality}
\label{sec:orgad340d4}
\subsubsection{\texttt{pdf-tools}}
\label{sec:org810d5ac}
...
\label{sec:org4816299}
\subsection{Git integration}
\label{sec:org27a888c}
\subsubsection{Direct Interaction}
\label{sec:orgbe92dab}
...
\label{sec:org1f7cba9}
\subsection{Syntax Checking}
\label{sec:org321c12d}
\subsubsection{Flycheck}
\label{sec:org642cb50}
...
\begin{enumerate}
\item Settings
\label{sec:orgf70c0de}
\begin{enumerate}
\item Enable Flycheck Globally
\label{sec:org9a28535}
...
\label{sec:orgf05d43a}
\subsubsection{Company Settings}
\label{sec:org4975b52}
\begin{itemize}
...
\end{minted}
\section{Languages}
\label{sec:org7dd0472}
\subsection{Common Lisp}
\label{sec:org353415d}
\subsubsection{Aggressive Indent}
\label{sec:org2e13a2a}
Enable aggressive indentation in all Lisp modes.
\begin{minted}[]{common-lisp}
(add-hook 'lisp-mode-hook #'aggressive-indent-mode)
\end{minted}
\subsection{Emacs Lisp}
\label{sec:orga68f40c}
\subsubsection{Hooks}
\label{sec:org0e73338}
...
\subsubsection{Fixes}
\label{sec:orgf1f5d56}
\begin{enumerate}
\item Advised Function Noise
\label{sec:org27025e0}
...
\end{minted}
\section{Performance}
\label{sec:org9a08768}
\subsection{Performance Mode}
\label{sec:org2659eb4}
...
\end{minted}
\section{Etc.}
\label{sec:org29d93ea}
\subsection{Miscellaneous Utilities}
\label{sec:orga6afd51}
\subsubsection{Alerts}
\label{sec:orgcab2a19}
\begin{minted}[]{common-lisp}
(use-package alert
  :demand t
  :config
