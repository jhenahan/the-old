...
\section{Basics}
\label{sec:orgf8e2775}
\subsection{Modern Libraries}
\label{sec:org007b735}
\subsubsection{Libraries}
\label{sec:org5e29c70}
\begin{enumerate}
\item Async
\label{sec:orgc0ff93f}
...
\label{sec:orgcc36b62}
\subsubsection{Default Directory}
\label{sec:orgd1154b0}
...
\label{sec:org9dbaed8}
\subsubsection{Settings}
\label{sec:orgca06876}
...
\label{sec:orged815a8}
\section{Package Management}
\label{sec:orgcf7dfb6}
\subsection{Package Management}
\label{sec:org536d2a3}
\subsubsection{Disable \texttt{package.el}}
\label{sec:orgc404154}
...
\label{sec:org435dca3}
\section{Customization}
\label{sec:orgfed9400}
\subsection{Customization Group}
\label{sec:org5c23b5b}
\subsubsection{THE group}
\label{sec:orgb59b506}
...
\label{sec:org6303e59}
\subsection{OS Integration}
\label{sec:org64c6564}
\subsubsection{OS-specific Customization}
\label{sec:orgc82c542}
\begin{enumerate}
\item OS detection
\label{sec:org3617c2c}
...
\label{sec:orgd8d9fe9}
\begin{enumerate}
\item Path Fixes
\label{sec:orgcd18433}
...
\label{sec:org1343d08}
\begin{enumerate}
\item macOS integration
\label{sec:org97edce2}
...
\label{sec:org5acb0eb}
\begin{verbatim}
(use-package ssh-config-mode)
\end{verbatim}

\subsubsection{YAML}
\label{sec:orgd28852c}
...
\end{verbatim}
\subsection{Emacs}
\label{sec:org2ad15bf}
\subsubsection{emacs.d Organization}
\label{sec:orgb9bcfb8}
\begin{enumerate}
\item \texttt{no-littering}
\label{sec:org944d044}
...
\label{sec:org6978800}
\subsection{Better Help}
\label{sec:org480e5ce}
\subsubsection{Helpful}
\label{sec:org4d7c821}
...
\end{verbatim}
\subsection{ElDoc}
\label{sec:org374e705}
\subsubsection{Settings}
\label{sec:org11ee686}
...
\end{verbatim}
\section{Keybindings}
\label{sec:org8e348d2}
\subsection{Binding Keys}
\label{sec:orgbe31b6f}

\subsubsection{Custom Prefix}
\label{sec:org12ff9d4}
...
\label{sec:orgd4a68af}
\begin{verbatim}
(use-package hydra
  :demand t)
\end{verbatim}
\section{UI}
\label{sec:org0c006f3}
\subsection{Appearance}
\label{sec:org1e3fa31}
\subsubsection{Basic Setup}
\label{sec:org3b1c56d}
...
\end{verbatim}
\subsection{Theme}
\label{sec:org59ee468}
\subsubsection{Utilities}
\label{sec:org8645402}
...
\label{sec:org98b5c9a}
\subsubsection{Diminish}
\label{sec:org149b6df}
...
\end{enumerate}
\subsection{Emojis!}
\label{sec:orga95d391}
\subsubsection{\texttt{emojify}}
\label{sec:org65b86f0}
...
\end{verbatim}
\section{Navigation}
\label{sec:org4c04208}
\subsection{Completion}
\label{sec:orgf191409}
\subsubsection{Packages}
\label{sec:org7fb4bde}
\begin{enumerate}
\item Smex - Frecency for command history
\label{sec:org3f77bb3}
...
\begin{enumerate}
\item Setup
\label{sec:org8ae8b57}
\begin{enumerate}
\item Lazy Loading
\label{sec:org29592c4}
...
\begin{enumerate}
\item Setup
\label{sec:org88dd1db}
\begin{enumerate}
\item Bindings
\label{sec:orga2efc80}
...
\label{sec:orgbe162c0}
\subsubsection{Dotfile shortcuts}
\label{sec:org6c6761b}
\begin{enumerate}
\item Prefix key
\label{sec:org46694a0}
...
\label{sec:orgd8a2a1c}
\begin{enumerate}
\item Symlinks
\label{sec:orgcdd3551}
...
\label{sec:org841e9c9}
\begin{enumerate}
\item Projectile
\label{sec:orgdc7c737}
...
\begin{enumerate}
\item Setup
\label{sec:org58437c3}
\begin{enumerate}
\item Enable projectile globally
\label{sec:org566818b}
...
\end{enumerate}
\subsection{Search}
\label{sec:org40c7571}
\subsubsection{Regular Expressions}
\label{sec:orge09bdf5}
\begin{enumerate}
\item Rx
\label{sec:orgf5800a2}
...
\begin{enumerate}
\item Setup
\label{sec:orgedb378f}
\begin{enumerate}
\item Version Hack
\label{sec:org61df3da}
...
\end{enumerate}
\section{Reading}
\label{sec:orga32b25f}
\subsection{PDF Functionality}
\label{sec:org2d93386}
\subsubsection{\texttt{pdf-tools}}
\label{sec:org72a8d79}
...
\label{sec:orgc7a9870}
\subsection{Git integration}
\label{sec:org8f2f208}
\subsubsection{Direct Interaction}
\label{sec:org6fe763e}
...
\label{sec:orga79788c}
\subsection{Syntax Checking}
\label{sec:org90b8401}
\subsubsection{Flycheck}
\label{sec:orgbc87da2}
...
\begin{enumerate}
\item Settings
\label{sec:orgcef2774}
\begin{enumerate}
\item Enable Flycheck Globally
\label{sec:org4bc332c}
...
\label{sec:org17b8f70}
\subsubsection{Company Settings}
\label{sec:orga294d14}
\begin{itemize}
...
\end{verbatim}
\section{Languages}
\label{sec:org133cac0}
\subsection{Common Lisp}
\label{sec:org546fc2f}
\subsubsection{Aggressive Indent}
\label{sec:orgfaca040}
Enable aggressive indentation in all Lisp modes.
\begin{verbatim}
(add-hook 'lisp-mode-hook #'aggressive-indent-mode)
\end{verbatim}
\subsection{Emacs Lisp}
\label{sec:org14edd79}
\subsubsection{Hooks}
\label{sec:orga8d086b}
...
\subsubsection{Fixes}
\label{sec:orgf14ca6e}
\begin{enumerate}
\item Advised Function Noise
\label{sec:org3465cc7}
...
\end{verbatim}
\section{Etc.}
\label{sec:org7e48ac8}
\subsection{Miscellaneous Utilities}
\label{sec:org7f26ff5}
\subsubsection{Eventually-obsolete Functions}
\label{sec:org8bdf7d2}
