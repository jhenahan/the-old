...
\section{Basics}
\label{sec:orgb309a60}
\subsection{Modern Libraries}
\label{sec:org51b79f9}
\subsubsection{Libraries}
\label{sec:org0540aca}
\begin{enumerate}
\item Async
\label{sec:orgae85685}
...
\label{sec:org5fb76e5}
\subsubsection{Default Directory}
\label{sec:org7387416}
...
\label{sec:org2cf0fdc}
\subsubsection{Settings}
\label{sec:orgad6e378}
...
\label{sec:org6b5c1fa}
\section{Package Management}
\label{sec:org6ac4db8}
\subsection{Package Management}
\label{sec:org2cd936e}
\subsubsection{Disable \texttt{package.el}}
\label{sec:org10b5efb}
...
\label{sec:org3661925}
\section{Customization}
\label{sec:org584495a}
\subsection{Customization Group}
\label{sec:org8ddb2d9}
\subsubsection{THE group}
\label{sec:org048fcf9}
...
\label{sec:orgec428a0}
\subsection{OS Integration}
\label{sec:orgeb4f26b}
\subsubsection{OS-specific Customization}
\label{sec:org5deac73}
\begin{enumerate}
\item OS detection
\label{sec:org0f6063b}
...
\label{sec:orged8f8f6}
\begin{enumerate}
\item Path Fixes
\label{sec:orgd5f5915}
...
\label{sec:org75acce3}
\begin{enumerate}
\item macOS integration
\label{sec:org09071d6}
...
\label{sec:orga7a81c1}
\begin{verbatim}
(use-package ssh-config-mode)
\end{verbatim}

\subsubsection{YAML}
\label{sec:org2002d05}
...
\end{verbatim}
\subsection{Emacs}
\label{sec:org5079eed}
\subsubsection{emacs.d Organization}
\label{sec:orgc5af73d}
\begin{enumerate}
\item \texttt{no-littering}
\label{sec:org7e5428e}
...
\label{sec:org0286a43}
\subsection{Better Help}
\label{sec:orgee2ccf6}
\subsubsection{Helpful}
\label{sec:org0957b90}
...
\end{verbatim}
\subsection{ElDoc}
\label{sec:orgfc1aa19}
\subsubsection{Settings}
\label{sec:org725bd63}
...
\end{verbatim}
\section{Keybindings}
\label{sec:orgbf14bef}
\subsection{Binding Keys}
\label{sec:org3074292}

\subsubsection{Custom Prefix}
\label{sec:org8aad7ed}
...
\label{sec:orgfdf0eca}
\begin{verbatim}
(use-package hydra
  :demand t)
\end{verbatim}
\section{UI}
\label{sec:orgdac6a4f}
\subsection{Appearance}
\label{sec:orgf7a0fdc}
\subsubsection{Basic Setup}
\label{sec:org8d77daf}
...
\end{verbatim}
\subsection{Theme}
\label{sec:org0c8a526}
\subsubsection{Utilities}
\label{sec:orgc374872}
...
\label{sec:orga91f091}
\subsubsection{Diminish}
\label{sec:org4c578c2}
...
\end{enumerate}
\subsection{Emojis!}
\label{sec:orga1196e3}
\subsubsection{\texttt{emojify}}
\label{sec:orgb8c69b3}
...
\end{verbatim}
\section{Navigation}
\label{sec:org93658fa}
\subsection{Completion}
\label{sec:org3e12f49}
\subsubsection{Packages}
\label{sec:orgd56ce5d}
\begin{enumerate}
\item Smex - Frecency for command history
\label{sec:org7428ede}
...
\begin{enumerate}
\item Setup
\label{sec:orgf7e12d3}
\begin{enumerate}
\item Lazy Loading
\label{sec:org994b4b8}
...
\label{sec:orgb9827bc}
\subsubsection{Dotfile shortcuts}
\label{sec:org53e8eae}
\begin{enumerate}
\item Prefix key
\label{sec:org27c1d50}
...
\label{sec:org2c83e67}
\begin{enumerate}
\item Symlinks
\label{sec:org9457606}
...
\label{sec:orgff01ff3}
\begin{enumerate}
\item Projectile
\label{sec:orgc1e1c90}
...
\begin{enumerate}
\item Setup
\label{sec:orgf23370c}
\begin{enumerate}
\item Enable projectile globally
\label{sec:org45a54fc}
...
\end{enumerate}
\subsection{Search}
\label{sec:orgab88353}
\subsubsection{Regular Expressions}
\label{sec:org1ab775a}
\begin{enumerate}
\item Rx
\label{sec:orgcae5986}
...
\begin{enumerate}
\item Setup
\label{sec:orgf00ec63}
\begin{enumerate}
\item Version Hack
\label{sec:orgeea39d0}
...
\item Settings
\label{sec:org63ec6d4}
\begin{verbatim}
(setq org-agenda-files '("~/org"))
\end{verbatim}
\end{enumerate}
\item \texttt{use-package} declaration
\label{sec:orge9af09c}
\begin{verbatim}
...
\label{sec:org99e17f3}
\subsubsection{Flyspell}
\label{sec:org78376d7}
...
\label{sec:orgd7376cf}
\subsubsection{Formatting Options}
\label{sec:org8297c16}
\begin{enumerate}
\item Formatting
\label{sec:org948041a}
\begin{enumerate}
\item Sanity
\label{sec:orgf929457}
...
\end{enumerate}
\section{Reading}
\label{sec:org29cf07b}
\subsection{PDF Functionality}
\label{sec:org5c7750e}
\subsubsection{\texttt{pdf-tools}}
\label{sec:org12d57ae}
...
\label{sec:orgf377df0}
\subsection{Git integration}
\label{sec:orge9ea858}
\subsubsection{Direct Interaction}
\label{sec:org74c4bbc}
...
\label{sec:org6f12a86}
\subsection{Syntax Checking}
\label{sec:org1bee1a6}
\subsubsection{Flycheck}
\label{sec:org1a54ccd}
...
\begin{enumerate}
\item Settings
\label{sec:orgbf2b508}
\begin{enumerate}
\item Enable Flycheck Globally
\label{sec:org6dd8b3e}
...
\label{sec:orgb71e747}
\subsubsection{Company Settings}
\label{sec:org9094d53}
\begin{itemize}
...
\end{verbatim}
\section{Languages}
\label{sec:org18528c2}
\subsection{Common Lisp}
\label{sec:org3a5842b}
\subsubsection{Aggressive Indent}
\label{sec:org4ae3492}
Enable aggressive indentation in all Lisp modes.
\begin{verbatim}
(add-hook 'lisp-mode-hook #'aggressive-indent-mode)
\end{verbatim}
\subsection{Emacs Lisp}
\label{sec:org9c7f083}
\subsubsection{Hooks}
\label{sec:orge063b20}
...
\subsubsection{Fixes}
\label{sec:orga0c7732}
\begin{enumerate}
\item Advised Function Noise
\label{sec:orga4e40bc}
...
\end{verbatim}
\section{Etc.}
\label{sec:org860339e}
\subsection{Miscellaneous Utilities}
\label{sec:org44114b8}
\subsubsection{Eventually-obsolete Functions}
\label{sec:orge651f13}
