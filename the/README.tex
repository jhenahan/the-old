...
\section{Basics}
\label{sec:org96b377e}
\subsection{Modern Libraries}
\label{sec:org2f47653}
\subsubsection{Libraries}
\label{sec:orge97c313}
\begin{enumerate}
\item Async
\label{sec:org5485bfd}
...
\label{sec:orgdee108f}
\subsubsection{Default Directory}
\label{sec:org00a721a}
...
\label{sec:org6613c2b}
\subsubsection{Settings}
\label{sec:orgfcda4f2}
...
\label{sec:org4e019d7}
\section{Package Management}
\label{sec:org79ac0f8}
\subsection{Package Management}
\label{sec:org356d094}
\subsubsection{Disable \texttt{package.el}}
\label{sec:orga56e560}
...
\label{sec:org86c152a}
\section{Customization}
\label{sec:org02cf3db}
\subsection{Customization Group}
\label{sec:org68ee755}
\subsubsection{THE group}
\label{sec:org0d207c3}
...
\label{sec:org65f84b6}
\subsection{OS Integration}
\label{sec:org8085a97}
\subsubsection{OS-specific Customization}
\label{sec:orgd8e651c}
\begin{enumerate}
\item OS detection
\label{sec:orgcfa9669}
...
\label{sec:org868e3a8}
\begin{enumerate}
\item Path Fixes
\label{sec:org5aff62f}
...
\label{sec:org0a0dc8a}
\begin{enumerate}
\item macOS integration
\label{sec:orgc6b1335}
...
\label{sec:org18b0ba1}
\begin{verbatim}
(use-package ssh-config-mode)
\end{verbatim}

\subsubsection{YAML}
\label{sec:orgacdf6fc}
...
\end{verbatim}
\subsection{Emacs}
\label{sec:org8f29db2}
\subsubsection{emacs.d Organization}
\label{sec:org093f770}
\begin{enumerate}
\item \texttt{no-littering}
\label{sec:orgbc2060d}
...
\label{sec:org27c7a00}
\subsection{Better Help}
\label{sec:orgc36db80}
\subsubsection{Helpful}
\label{sec:org2db496d}
...
\end{verbatim}
\subsection{ElDoc}
\label{sec:orgf4aa06c}
\subsubsection{Settings}
\label{sec:orgb7eed9e}
...
\end{verbatim}
\section{Keybindings}
\label{sec:org83c5d0b}
\subsection{Binding Keys}
\label{sec:org1c3e8fa}

\subsubsection{Custom Prefix}
\label{sec:org3ab2898}
...
\label{sec:org6607de1}
\begin{verbatim}
(use-package hydra
  :demand t)
\end{verbatim}
\section{UI}
\label{sec:orgf794c96}
\subsection{Appearance}
\label{sec:org8f686e0}
\subsubsection{Basic Setup}
\label{sec:org6f0b4d2}
...
\end{verbatim}
\subsection{Theme}
\label{sec:org9b4a0ed}
\subsubsection{Utilities}
\label{sec:org9c5ad7e}
...
\label{sec:org45b637d}
\subsubsection{Diminish}
\label{sec:org6cbf3b6}
...
\end{enumerate}
\subsection{Emojis!}
\label{sec:org10d15e2}
\subsubsection{\texttt{emojify}}
\label{sec:org8267845}
...
\end{verbatim}
\section{Navigation}
\label{sec:orgb6ea243}
\subsection{Completion}
\label{sec:org2583d72}
\subsubsection{Packages}
\label{sec:orgf3913a6}
\begin{enumerate}
\item Smex - Frecency for command history
\label{sec:orgc5a4602}
...
\begin{enumerate}
\item Setup
\label{sec:org61f61c4}
\begin{enumerate}
\item Lazy Loading
\label{sec:orgf880d56}
...
\begin{enumerate}
\item Setup
\label{sec:org0890544}
\begin{enumerate}
\item Bindings
\label{sec:orgb62221c}
...
\label{sec:org47589a0}
\subsubsection{Dotfile shortcuts}
\label{sec:org6211b42}
\begin{enumerate}
\item Prefix key
\label{sec:org9fb4211}
...
\label{sec:orge1660c5}
\begin{enumerate}
\item Symlinks
\label{sec:org664ed28}
...
\label{sec:org65c1833}
\begin{enumerate}
\item Projectile
\label{sec:orgceb0d5e}
...
\begin{enumerate}
\item Setup
\label{sec:orgd2720ff}
\begin{enumerate}
\item Enable projectile globally
\label{sec:orgfc5c3aa}
...
\end{enumerate}
\subsection{Search}
\label{sec:org88311a7}
\subsubsection{Regular Expressions}
\label{sec:org3d6f56d}
\begin{enumerate}
\item Rx
\label{sec:org5f9bd2b}
...
\begin{enumerate}
\item Setup
\label{sec:org792a64b}
\begin{enumerate}
\item Version Hack
\label{sec:orga146dcd}
...
\item Settings
\label{sec:orge9b3fe0}
\begin{verbatim}
(setq org-agenda-files '("~/org"))
\end{verbatim}
\end{enumerate}
\item \texttt{use-package} declaration
\label{sec:org94358d3}
\begin{verbatim}
...
\label{sec:org39e79b2}
\subsubsection{Flyspell}
\label{sec:org38521ac}
...
\label{sec:org18a5625}
\subsubsection{Formatting Options}
\label{sec:org1730671}
\begin{enumerate}
\item Formatting
\label{sec:org03a1c92}
\begin{enumerate}
\item Sanity
\label{sec:orgbba2360}
...
\end{enumerate}
\section{Reading}
\label{sec:org168ac5f}
\subsection{PDF Functionality}
\label{sec:org8945202}
\subsubsection{\texttt{pdf-tools}}
\label{sec:orgc424c64}
...
\label{sec:org24bba3e}
\subsection{Git integration}
\label{sec:orgfc2cf0f}
\subsubsection{Direct Interaction}
\label{sec:orgb5bd1ce}
...
\label{sec:org78ca9c7}
\subsection{Syntax Checking}
\label{sec:orgd1bf320}
\subsubsection{Flycheck}
\label{sec:org5c5b8f5}
...
\begin{enumerate}
\item Settings
\label{sec:orgb58bb3b}
\begin{enumerate}
\item Enable Flycheck Globally
\label{sec:org7d67d06}
...
\label{sec:orgf946ad2}
\subsubsection{Company Settings}
\label{sec:org6034fd3}
\begin{itemize}
...
\end{verbatim}
\section{Languages}
\label{sec:org9c7087e}
\subsection{Common Lisp}
\label{sec:org6b70b9e}
\subsubsection{Aggressive Indent}
\label{sec:org8ac8f14}
Enable aggressive indentation in all Lisp modes.
\begin{verbatim}
(add-hook 'lisp-mode-hook #'aggressive-indent-mode)
\end{verbatim}
\subsection{Emacs Lisp}
\label{sec:orgac6edb5}
\subsubsection{Hooks}
\label{sec:org155df6f}
...
\subsubsection{Fixes}
\label{sec:orgcc12b3e}
\begin{enumerate}
\item Advised Function Noise
\label{sec:org096cb5b}
...
\end{verbatim}
\section{Etc.}
\label{sec:org3449b3b}
\subsection{Miscellaneous Utilities}
\label{sec:org60491e7}
\subsubsection{Eventually-obsolete Functions}
\label{sec:orga60b678}
