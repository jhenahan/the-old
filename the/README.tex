...
\section{Basics}
\label{sec:org6981fcb}
\subsection{Modern Libraries}
\label{sec:orgc799730}
\subsubsection{Libraries}
\label{sec:orgc9b068a}
\begin{enumerate}
\item Async
\label{sec:org4ea8927}
...
\label{sec:orgf2182ec}
\subsubsection{Default Directory}
\label{sec:org7b041d1}
...
\label{sec:org202adb9}
\section{Package Management}
\label{sec:org6ae8a14}
\subsection{Package Management}
\label{sec:org81306e3}
\subsubsection{Disable \texttt{package.el}}
\label{sec:org473f3cd}
...
\label{sec:org57f1373}
\section{Customization}
\label{sec:orgeb06952}
\subsection{Customization Group}
\label{sec:org14b67ec}
\subsubsection{THE group}
\label{sec:org84b87d9}
...
\label{sec:org6845a39}
\subsection{OS Integration}
\label{sec:org1da9613}
\subsubsection{OS-specific Customization}
\label{sec:orge3feab1}
\begin{enumerate}
\item OS detection
\label{sec:org8fcbd55}
...
\label{sec:orge4b527d}
\begin{enumerate}
\item Path Fixes
\label{sec:org0f33f8f}
...
\label{sec:org8a210c3}
\begin{enumerate}
\item macOS integration
\label{sec:org04853b9}
...
\label{sec:org1cdaeef}
\begin{verbatim}
(use-package ssh-config-mode)
\end{verbatim}

\subsubsection{YAML}
\label{sec:org8484751}
...
\end{verbatim}
\subsection{Emacs}
\label{sec:org9fdb727}
\subsubsection{emacs.d Organization}
\label{sec:orga518e50}
\begin{enumerate}
\item \texttt{no-littering}
\label{sec:orgb34f637}
...
\label{sec:orgd0590c2}
\subsection{Better Help}
\label{sec:orge698d71}
\subsubsection{Helpful}
\label{sec:org9eb1865}
...
\end{verbatim}
\subsection{ElDoc}
\label{sec:org12a33d0}
\subsubsection{Settings}
\label{sec:org10f7d63}
...
\end{verbatim}
\section{Keybindings}
\label{sec:orgb31e2b6}
\subsection{Binding Keys}
\label{sec:orga5ac9a6}

\subsubsection{Custom Prefix}
\label{sec:org948fc70}
...
\label{sec:org67f4344}
\begin{verbatim}
(use-package hydra
  :demand t)
\end{verbatim}
\section{UI}
\label{sec:org1e13b95}
\subsection{Appearance}
\label{sec:org406873f}
\subsubsection{Basic Setup}
\label{sec:org597ec0f}
...
\end{verbatim}
\subsection{Theme}
\label{sec:orgc09d68c}
\subsubsection{Utilities}
\label{sec:org7c4153a}
...
\label{sec:org4be2a72}
\subsubsection{Diminish}
\label{sec:org1600f3f}
...
\end{enumerate}
\subsection{Emojis!}
\label{sec:org42b6af5}
\subsubsection{\texttt{emojify}}
\label{sec:orgfc3ac6d}
...
\end{verbatim}
\section{Navigation}
\label{sec:org0704f08}
\subsection{Completion}
\label{sec:org8a54bec}
\subsubsection{Packages}
\label{sec:org5d7f901}
\begin{enumerate}
\item Smex - Frecency for command history
\label{sec:org2aa4045}
...
\begin{enumerate}
\item Setup
\label{sec:orga7ad664}
\begin{enumerate}
\item Lazy Loading
\label{sec:orge97c732}
...
\begin{enumerate}
\item Setup
\label{sec:org2bd5270}
\begin{enumerate}
\item Bindings
\label{sec:org9a4868b}
...
\label{sec:org2e371ff}
\subsubsection{Dotfile shortcuts}
\label{sec:orgd4c4dfd}
\begin{enumerate}
\item Prefix key
\label{sec:org777067b}
...
\label{sec:orgf0be552}
\begin{enumerate}
\item Symlinks
\label{sec:orgfe59e7c}
...
\end{enumerate}
\subsection{Search}
\label{sec:org2f365dc}
\subsubsection{Regular Expressions}
\label{sec:org4e4b8bf}
\begin{enumerate}
\item Rx
\label{sec:org49717d7}
...
\begin{enumerate}
\item Setup
\label{sec:org996df84}
\begin{enumerate}
\item Version Hack
\label{sec:org46bc97a}
...
\item Settings
\label{sec:org15e0d93}
\begin{verbatim}
(setq org-agenda-files '("~/org"))
\end{verbatim}
\end{enumerate}
\item \texttt{use-package} declaration
\label{sec:org4f047aa}
\begin{verbatim}
...
\label{sec:org2b1da72}
\subsubsection{Flyspell}
\label{sec:org95277d7}
...
\label{sec:orgcced5c2}
\subsubsection{Formatting Options}
\label{sec:org433071b}
\begin{enumerate}
\item Formatting
\label{sec:org0c7bb1b}
\begin{enumerate}
\item Sanity
\label{sec:org4ce0c3f}
...
\end{enumerate}
\section{Reading}
\label{sec:org3c77f36}
\subsection{PDF Functionality}
\label{sec:org47275fb}
\subsubsection{\texttt{pdf-tools}}
\label{sec:org5aab657}
...
\label{sec:orgd812369}
\subsection{Git integration}
\label{sec:org6f66c5b}
\subsubsection{Direct Interaction}
\label{sec:org337f510}
...
\label{sec:org5e7ec7c}
\subsection{Syntax Checking}
\label{sec:org14d0bd5}
\subsubsection{Flycheck}
\label{sec:orgb525584}
...
\begin{enumerate}
\item Settings
\label{sec:org6b67da5}
\begin{enumerate}
\item Enable Flycheck Globally
\label{sec:org6f5bf45}
...
\label{sec:org16fd38a}
\subsubsection{Company Settings}
\label{sec:org54bcbea}
\begin{itemize}
...
\end{verbatim}
\section{Languages}
\label{sec:org26e1007}
\subsection{Common Lisp}
\label{sec:orgad23337}
\subsubsection{Aggressive Indent}
\label{sec:orgc003989}
Enable aggressive indentation in all Lisp modes.
\begin{verbatim}
(add-hook 'lisp-mode-hook #'aggressive-indent-mode)
\end{verbatim}
\subsection{Emacs Lisp}
\label{sec:orgcd75820}
\subsubsection{Hooks}
\label{sec:org9516deb}
...
\subsubsection{Fixes}
\label{sec:org75c6c9a}
\begin{enumerate}
\item Advised Function Noise
\label{sec:orgf44db98}
...
\end{verbatim}
\section{Etc.}
\label{sec:org760b5c3}
\subsection{Miscellaneous Utilities}
\label{sec:org2a93690}
\subsubsection{Eventually-obsolete Functions}
\label{sec:orgacd15c2}
