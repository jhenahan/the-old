...
\section{Basics}
\label{sec:org09b90de}
\subsection{Modern Libraries}
\label{sec:orgf7abe6a}
\subsubsection{Libraries}
\label{sec:orgf1a6360}
\begin{enumerate}
\item Async
\label{sec:orgecfaa45}
...
\label{sec:orge19e1f7}
\subsubsection{Default Directory}
\label{sec:org4aee6d9}
...
\label{sec:orge50a4a0}
\subsubsection{Settings}
\label{sec:org4bba6a3}
...
\label{sec:org6917412}
\section{Package Management}
\label{sec:orga70b6e6}
\subsection{Package Management}
\label{sec:org810cb8f}
\subsubsection{Disable \texttt{package.el}}
\label{sec:orge9491b3}
...
\label{sec:org7f76bbe}
\section{Customization}
\label{sec:org518562f}
\subsection{Customization Group}
\label{sec:org36aba03}
\subsubsection{THE group}
\label{sec:org3c8a877}
...
\label{sec:org0f4f36f}
\subsection{OS Integration}
\label{sec:orgf86f6d0}
...
\label{sec:org93580ad}
\begin{enumerate}
\item macOS integration
\label{sec:orgd161866}
...
\label{sec:orgfa9b341}
\begin{verbatim}
(use-package ssh-config-mode)
\end{verbatim}

\subsubsection{YAML}
\label{sec:orgc94ee5a}
...
\end{verbatim}
\subsection{Emacs}
\label{sec:org819b96c}
\subsubsection{emacs.d Organization}
\label{sec:orgab21b47}
\begin{enumerate}
\item \texttt{no-littering}
\label{sec:org418e2d8}
...
\label{sec:orge4bc69b}
\subsection{Better Help}
\label{sec:org24b8be6}
\subsubsection{Helpful}
\label{sec:org88d55e4}
...
\end{verbatim}
\subsection{ElDoc}
\label{sec:orgf0db2f0}
\subsubsection{Settings}
\label{sec:org3a0c274}
...
\end{verbatim}
\section{Keybindings}
\label{sec:orgef89a06}
\subsection{Binding Keys}
\label{sec:org9c5d657}

\subsubsection{Custom Prefix}
\label{sec:orgc6e4869}
...
\label{sec:orge2fc42c}
\begin{verbatim}
(use-package hydra
  :demand t)
\end{verbatim}
\section{UI}
\label{sec:org3e8a52a}
\subsection{Appearance}
\label{sec:orgf5f6cde}
\subsubsection{Basic Setup}
\label{sec:org4856902}
...
\end{verbatim}
\subsection{Theme}
\label{sec:org7b3fe69}
\subsubsection{Utilities}
\label{sec:orge7b083d}
...
\label{sec:org2fda9a3}
\subsubsection{Diminish}
\label{sec:orgd134ff5}
...
\end{enumerate}
\subsection{Emojis!}
\label{sec:org0e41ce7}
\subsubsection{\texttt{emojify}}
\label{sec:org36ea3f3}
...
\end{verbatim}
\section{Navigation}
\label{sec:orge88c333}
\subsection{Completion}
\label{sec:orgb647243}
\subsubsection{Packages}
\label{sec:org92fcdda}
\begin{enumerate}
\item Smex - Frecency for command history
\label{sec:orgfc7e87f}
...
\begin{enumerate}
\item Setup
\label{sec:orgbd85540}
\begin{enumerate}
\item Lazy Loading
\label{sec:orgd999f9a}
...
\begin{enumerate}
\item Setup
\label{sec:org9a82365}
\begin{enumerate}
\item Bindings
\label{sec:org76ee6d3}
...
\label{sec:org8338497}
\subsubsection{Dotfile shortcuts}
\label{sec:orge2811ca}
\begin{enumerate}
\item Prefix key
\label{sec:orgd3e2255}
...
\label{sec:orgc8fd76a}
\begin{enumerate}
\item Symlinks
\label{sec:org0af11f4}
...
\label{sec:orgae61d22}
\begin{enumerate}
\item Projectile
\label{sec:org0053928}
...
\begin{enumerate}
\item Setup
\label{sec:org069ff02}
\begin{enumerate}
\item Enable projectile globally
\label{sec:org10ef2d1}
...
\end{enumerate}
\subsection{Search}
\label{sec:org4937ad9}
\subsubsection{Regular Expressions}
\label{sec:orgabba8e2}
\begin{enumerate}
\item Rx
\label{sec:orga4c4a1b}
...
\begin{enumerate}
\item Setup
\label{sec:orgf85f959}
\begin{enumerate}
\item Version Hack
\label{sec:org583fe3e}
...
\begin{enumerate}
\item Setup
\label{sec:orgd021db8}
\begin{enumerate}
\item Bindings
\label{sec:org64c5683}
...
\label{sec:org4fa1ad0}
\begin{enumerate}
\item Formatting
\label{sec:org88f2857}
\begin{enumerate}
\item Sanity
\label{sec:org3bb2e1c}
...
\end{enumerate}
\section{Reading}
\label{sec:org6701158}
\subsection{PDF Functionality}
\label{sec:org6798fed}
\subsubsection{\texttt{pdf-tools}}
\label{sec:org8315d1f}
...
\label{sec:orgc0b2ec8}
\subsection{Git integration}
\label{sec:org810265e}
\subsubsection{Direct Interaction}
\label{sec:orgb2598ea}
...
\label{sec:org12479bd}
\subsubsection{Company Settings}
\label{sec:orgfc1ab1d}
\begin{itemize}
...
\end{verbatim}
\section{Languages}
\label{sec:org9cda1fb}
\subsection{Common Lisp}
\label{sec:orga5edccc}
\subsubsection{Aggressive Indent}
\label{sec:org35ba896}
Enable aggressive indentation in all Lisp modes.
\begin{verbatim}
(add-hook 'lisp-mode-hook #'aggressive-indent-mode)
\end{verbatim}
\subsection{Emacs Lisp}
\label{sec:org75ef5c5}
\subsubsection{Hooks}
\label{sec:org7ab7aba}
...
\subsubsection{Fixes}
\label{sec:orge85cd41}
\begin{enumerate}
\item Advised Function Noise
\label{sec:orgb628fe2}
...
\end{verbatim}
\section{Etc.}
\label{sec:org5a12e04}
\subsection{Miscellaneous Utilities}
\label{sec:orgeabef6e}
\subsubsection{Eventually-obsolete Functions}
\label{sec:org707ea22}
