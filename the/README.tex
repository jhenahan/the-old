...
\section{Basics}
\label{sec:orgafb7135}
\subsection{Modern Libraries}
\label{sec:org2fd0e43}
\subsubsection{Libraries}
\label{sec:org68b0500}
\begin{enumerate}
\item Async
\label{sec:org8efc899}
...
\label{sec:orgd73a47a}
\subsubsection{Default Directory}
\label{sec:orgf31e54e}
...
\label{sec:orgfc687ef}
\subsubsection{Settings}
\label{sec:org85c3fb0}
...
\label{sec:org78831ef}
\section{Package Management}
\label{sec:org5eeb872}
\subsection{Package Management}
\label{sec:org450679d}
\subsubsection{Disable \texttt{package.el}}
\label{sec:orgd70f582}
...
\label{sec:org2502568}
\subsubsection{El-Patch}
\label{sec:org6916178}
...
\label{sec:orgdc6fe84}
\subsection{OS Integration}
\label{sec:org8801590}
\subsubsection{OS-specific Customization}
\label{sec:orga2d81b1}
\begin{enumerate}
\item OS detection
\label{sec:org305654e}
...
\label{sec:orgaafdae1}
\begin{enumerate}
\item Path Fixes
\label{sec:org5886145}
...
\label{sec:orgaf97217}
\begin{enumerate}
\item macOS integration
\label{sec:orga5c0c60}
...
\label{sec:orge2cae97}
\begin{minted}[]{common-lisp}
(use-package ssh-config-mode)
\end{minted}

\subsubsection{YAML}
\label{sec:orgd9f091c}
...
\end{minted}
\subsection{Emacs}
\label{sec:orgdd41222}
\subsubsection{emacs.d Organization}
\label{sec:org6cc8682}
\begin{enumerate}
\item \texttt{no-littering}
\label{sec:orgd415b69}
...
\label{sec:orgc2be573}
\subsection{Better Help}
\label{sec:org63ed20d}
\subsubsection{Helpful}
\label{sec:org16bcb43}
...
\end{minted}
\subsection{ElDoc}
\label{sec:org3675c2c}
\subsubsection{Settings}
\label{sec:org70978f3}
...
\end{minted}
\section{Keybindings}
\label{sec:orgce77ca2}
\subsection{Binding Keys}
\label{sec:org7813e0b}
\subsubsection{Custom Prefix}
\label{sec:org470ba0c}
...
\end{minted}
\section{Navigation}
\label{sec:orgbe216b9}
\subsection{Completion}
\label{sec:org3be787f}
\subsubsection{Packages}
\label{sec:org1a13a9c}
\begin{enumerate}
\item Smex - Frecency for command history
\label{sec:org9493614}
...
\begin{enumerate}
\item Setup
\label{sec:orgedac263}
\begin{enumerate}
\item Lazy Loading
\label{sec:orgb4b3cd2}
...
\begin{enumerate}
\item Setup
\label{sec:org7bb477c}
\begin{enumerate}
\item Bindings
\label{sec:org98af079}
...
\label{sec:org5b8f85f}
\subsubsection{Dotfile shortcuts}
\label{sec:orge7367b2}
\begin{enumerate}
\item Prefix key
\label{sec:org796fb7c}
...
\label{sec:org08da2b4}
\begin{enumerate}
\item Projectile
\label{sec:orgb001f90}
...
\begin{enumerate}
\item Setup
\label{sec:orgc2aec20}
\begin{enumerate}
\item Enable projectile globally
\label{sec:org2cbd969}
...
\label{sec:org2a8b17e}
\subsubsection{Mark Ring Navigation}
\label{sec:orga6d1332}
\begin{minted}[]{common-lisp}
...
\label{sec:org0cafe2c}
\begin{minted}[]{common-lisp}
(use-package expand-region
  :demand t)
\end{minted}
\subsubsection{Vimish Fold}
\label{sec:orgc567c35}
\begin{minted}[]{common-lisp}
...
\end{minted}
\subsection{Search}
\label{sec:org5b1c0ee}
\subsubsection{Regular Expressions}
\label{sec:org8087abc}
\begin{enumerate}
\item Rx
\label{sec:org22eb042}
...
\begin{enumerate}
\item Setup
\label{sec:org749f009}
\begin{enumerate}
\item Version Hack
\label{sec:org0714f0b}
...
\label{sec:org5d518a0}
\subsubsection{AUCTeX}
\label{sec:org886bf46}
\begin{minted}[]{common-lisp}
(use-package tex
  :demand t
  :straight auctex
...
\label{sec:orgda1ec43}
\subsubsection{Formatting Options}
\label{sec:org341cd39}
\begin{enumerate}
\item Formatting
\label{sec:org95e030f}
\begin{enumerate}
\item Sanity
\label{sec:org969fd84}
...
\end{enumerate}
\section{Reading}
\label{sec:org5c69d1a}
\subsection{PDF Functionality}
\label{sec:org2498e34}
\subsubsection{\texttt{pdf-tools}}
\label{sec:orgc5165e6}
...
\label{sec:org2cc7193}
\subsection{Git integration}
\label{sec:org8e8513b}
\subsubsection{Direct Interaction}
\label{sec:org177f887}
...
\label{sec:orgd17db68}
\subsection{Syntax Checking}
\label{sec:orgf74aee5}
\subsubsection{Flycheck}
\label{sec:orgbaf5c6f}
...
\label{sec:org56b8b65}
\subsubsection{Company Settings}
\label{sec:org1d0416b}
\begin{itemize}
...
\end{minted}
\section{Languages}
\label{sec:org2cfd11b}
\subsection{Common Lisp}
\label{sec:orgf14e06e}
\subsubsection{Aggressive Indent}
\label{sec:orgf32a3b3}
Enable aggressive indentation in all Lisp modes.
\begin{minted}[]{common-lisp}
(add-hook 'lisp-mode-hook #'aggressive-indent-mode)
\end{minted}
\subsection{Emacs Lisp}
\label{sec:orge0e6b68}
\subsubsection{Hooks}
\label{sec:org9f4278b}
...
\subsubsection{Fixes}
\label{sec:orgd5ea579}
\begin{enumerate}
\item Advised Function Noise
\label{sec:orgf7ca3b6}
...
\end{minted}
\section{Performance}
\label{sec:org9f3f4ec}
\subsection{Performance Mode}
\label{sec:org70a9081}
...
\end{minted}
\section{Etc.}
\label{sec:org2b86216}
\subsection{Miscellaneous Utilities}
\label{sec:orge6b133b}
\subsubsection{Alerts}
\label{sec:org06ee054}
\begin{minted}[]{common-lisp}
(use-package alert
  :demand t
  :config
