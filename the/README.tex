...
\section{Basics}
\label{sec:org8cb7f91}
\subsection{Modern Libraries}
\label{sec:org1b8181c}
\subsubsection{Libraries}
\label{sec:org7e330bc}
\begin{enumerate}
\item Async
\label{sec:org341d81f}
...
\label{sec:orgfab1648}
\subsubsection{Default Directory}
\label{sec:org1b1ca36}
...
\label{sec:org0fb2e2b}
\subsubsection{Settings}
\label{sec:org0478ce7}
...
\label{sec:org5db7ee1}
\section{Customization}
\label{sec:orgdd0751e}
\subsection{Customization Group}
\label{sec:org4f7def5}
\subsubsection{THE group}
\label{sec:org52ef37a}
...
\label{sec:orgc0ac322}
\subsection{OS Integration}
\label{sec:orgcb4180a}
\subsubsection{OS-specific Customization}
\label{sec:org4131e8f}
\begin{enumerate}
\item OS detection
\label{sec:orgcefc9b3}
...
\label{sec:org576b1e4}
\begin{enumerate}
\item Path Fixes
\label{sec:orga12284d}
...
\label{sec:orgf9654ed}
\begin{enumerate}
\item macOS integration
\label{sec:org97aede1}
...
\label{sec:orgc26e01e}
\begin{verbatim}
(use-package ssh-config-mode)
\end{verbatim}

\subsubsection{YAML}
\label{sec:orgcb54833}
...
\end{verbatim}
\subsection{Emacs}
\label{sec:org6de36af}
\subsubsection{emacs.d Organization}
\label{sec:org338be2b}
\begin{enumerate}
\item \texttt{no-littering}
\label{sec:orge0e26f4}
...
\label{sec:orgcc890bc}
\subsection{Better Help}
\label{sec:orgd506741}
\subsubsection{Helpful}
\label{sec:org4710ac6}
...
\end{verbatim}
\subsection{ElDoc}
\label{sec:org1a8de56}
\subsubsection{Settings}
\label{sec:orge028b48}
...
\end{verbatim}
\section{Keybindings}
\label{sec:org1dcb745}
\subsection{Binding Keys}
\label{sec:org1e49a86}

\subsubsection{Custom Prefix}
\label{sec:org71b9f80}
...
\label{sec:org369c83a}
\begin{verbatim}
(use-package hydra
  :demand t)
\end{verbatim}
\section{UI}
\label{sec:org800153e}
\subsection{Appearance}
\label{sec:org82f1742}
\subsubsection{Basic Setup}
\label{sec:org6199238}
...
\end{verbatim}
\subsection{Theme}
\label{sec:org8f2dd48}
\subsubsection{Utilities}
\label{sec:orgb018a4b}
...
\label{sec:org48d6759}
\subsubsection{Diminish}
\label{sec:org0901c42}
...
\end{enumerate}
\subsection{Emojis!}
\label{sec:org7a5a85b}
\subsubsection{\texttt{emojify}}
\label{sec:orgbda496b}
...
\end{verbatim}
\section{Navigation}
\label{sec:org5d79048}
\subsection{Completion}
\label{sec:org5859757}
\subsubsection{Packages}
\label{sec:org60905c3}
\begin{enumerate}
\item Smex - Frecency for command history
\label{sec:orgfaaf79d}
...
\begin{enumerate}
\item Setup
\label{sec:org42b4fd7}
\begin{enumerate}
\item Lazy Loading
\label{sec:org39d2858}
...
\begin{enumerate}
\item Setup
\label{sec:orgacc7e09}
\begin{enumerate}
\item Bindings
\label{sec:orgce02dd8}
...
\label{sec:orgd92c33d}
\subsubsection{Dotfile shortcuts}
\label{sec:org605e216}
\begin{enumerate}
\item Prefix key
\label{sec:orgb6549a1}
...
\label{sec:orgf60d7b3}
\begin{enumerate}
\item Symlinks
\label{sec:org22771fd}
...
\label{sec:org56e705a}
\begin{enumerate}
\item Projectile
\label{sec:org20766e9}
...
\begin{enumerate}
\item Setup
\label{sec:org9eabd1c}
\begin{enumerate}
\item Enable projectile globally
\label{sec:org46d4785}
\begin{verbatim}
(projectile-mode +1)
\end{verbatim}
\item Directory-local indexing
\label{sec:orge79229e}
...
\end{enumerate}
\subsection{Search}
\label{sec:org905e6e7}
\subsubsection{Regular Expressions}
\label{sec:orgcf12103}
\begin{enumerate}
\item Rx
\label{sec:orgb801534}
...
\begin{enumerate}
\item Setup
\label{sec:org7fbcef5}
\begin{enumerate}
\item Version Hack
\label{sec:orgecec934}
...
\item Settings
\label{sec:orgbb420ba}
\begin{verbatim}
(setq org-agenda-files '("~/org"))
\end{verbatim}
\end{enumerate}
\item \texttt{use-package} declaration
\label{sec:orgdd64345}
\begin{verbatim}
...
\label{sec:org75480cb}
\subsubsection{Flyspell}
\label{sec:org6827c12}
...
\label{sec:orge6aed88}
\subsubsection{Formatting Options}
\label{sec:org72a9ef4}
\begin{enumerate}
\item Formatting
\label{sec:orga27b2a7}
\begin{enumerate}
\item Sanity
\label{sec:org2f375cb}
...
\end{enumerate}
\section{Reading}
\label{sec:org95d41c5}
\subsection{PDF Functionality}
\label{sec:org09e720d}
\subsubsection{\texttt{pdf-tools}}
\label{sec:orge3646b2}
...
\label{sec:orge44a1dd}
\subsection{Git integration}
\label{sec:org64ab825}
\subsubsection{Direct Interaction}
\label{sec:org9871a79}
...
\label{sec:org84030aa}
\subsection{Syntax Checking}
\label{sec:orgfb519d4}
\subsubsection{Flycheck}
\label{sec:org2e55729}
...
\begin{enumerate}
\item Settings
\label{sec:org93a160f}
\begin{enumerate}
\item Enable Flycheck Globally
\label{sec:orgb382f34}
...
\end{verbatim}
\section{Languages}
\label{sec:org0744cf4}
\subsection{Common Lisp}
\label{sec:org0b5acc4}
\subsubsection{Aggressive Indent}
\label{sec:org496b2e0}
Enable aggressive indentation in all Lisp modes.
\begin{verbatim}
(add-hook 'lisp-mode-hook #'aggressive-indent-mode)
\end{verbatim}
\subsection{Emacs Lisp}
\label{sec:orgf44cb3e}
\subsubsection{Hooks}
\label{sec:org96302df}
...
\subsubsection{Fixes}
\label{sec:org6c7ea5d}
\begin{enumerate}
\item Advised Function Noise
\label{sec:org2139e41}
...
\end{verbatim}
\section{Etc.}
\label{sec:org8fb356b}
\subsection{Miscellaneous Utilities}
\label{sec:orge493df2}
\subsubsection{Eventually-obsolete Functions}
\label{sec:orgadcc0c7}
